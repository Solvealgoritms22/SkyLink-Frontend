...
import { Component, AfterViewInit, OnInit, HostListener, HostBinding, inject } from '@angular/core';
...
@Component({
        ...
        <div>
            <div>
                <div class="flex h-screen font-sans bg-surface-900 text-slate-100">
                    ...
                    <aside *ngIf="isDesktop && sidebarVisible" class="dark-sidebar sidebar-desktop">
                        <div class="p-3 h-full flex flex-col bg-surface-900 text-slate-100 overflow-auto">
                            <header class="flex items-center gap-2 mb-2 select-none">
                            ...
                            <p-scrollPanel [ngStyle]="{ width: '100%', flex: '1 1 auto' }">
                                <p-panelMenu [model]="menuItems" [style]="{ border: 'none', width: '100%' }" class="dark-menu"></p-panelMenu>
                            </p-scrollPanel>
                        </div>
                    </aside>

                    <!-- Sidebar modal en mobile/tablet -->
                    <p-sidebar *ngIf="!isDesktop" [(visible)]="sidebarVisible" [modal]="true" [dismissible]="false" [showCloseIcon]="true" [baseZIndex]="1000" [ngClass]="{ 'dark-sidebar': true, 'sidebar-mobile': true }">
                        <ng-template pTemplate="content">
                            <div class="p-3 h-full flex flex-col bg-surface-900 text-slate-100">
                    ...
                    <!-- Área principal -->
                    <main class="flex-1 overflow-y-auto p-6 md:p-10 bg-surface-900 transition-all" [class.ml-0]="!sidebarVisible || !isDesktop" [class.ml-72]="sidebarVisible && isDesktop">
                        <ng-container [ngSwitch]="activeSection">
                            <!-- Información General -->
                            <app-general-info-section *ngSwitchCase="'database'" [sqlCode]="generalInfo" [generalInfoDetail]="generalInfoData"> </app-general-info-section>

                            <!-- Tablas -->
                            <app-table-section
                                *ngSwitchCase="'table_airports'"
                                tableName="airports"
                            ...
                            <app-table-section
                                *ngSwitchCase="'table_fare_classes'"
                            ...
                            <app-table-section
                                *ngSwitchCase="'table_flight_fares'"
                            ...
                            <app-table-section
                                *ngSwitchCase="'table_loyalty_programs'"
                            ...
                            <app-table-section
                                *ngSwitchCase="'table_booking_passengers'"
                            ...
                            <app-table-section *ngSwitchCase="'table_payments'" tableName="payments" description="Gestiona pagos de reservas con monto, método y estado." [sqlCode]="tablesScript.payments" [tableDetail]="dataDictionary.payments">
                            </app-table-section>

                            <app-table-section *ngSwitchCase="'table_baggage'" tableName="baggage" description="Registra equipajes por boleto con peso y etiqueta única." [sqlCode]="tablesScript.baggage" [tableDetail]="dataDictionary.baggage">
                            </app-table-section>

                            <app-table-section
                                *ngSwitchCase="'table_staff'"
                                tableName="staff"
                            ...
                            <app-table-section
                                *ngSwitchCase="'table_crew_assignments'"
                            ...
                            <app-table-section
                                *ngSwitchCase="'table_boarding_passes'"
                            ...
                            <app-table-section
                                *ngSwitchCase="'table_maintenance_logs'"
                            ...
                            <app-table-section
                                *ngSwitchCase="'table_flight_status_history'"
                                tableName="flight_status_history"
                                description="Historial de cambios de estado de vuelos with fecha y hora."
                            ...
                            <app-table-section
                                *ngSwitchCase="'table_reservations_history'"
                            ...
                            <app-table-section
                                *ngSwitchCase="'table_seat_inventory'"
                            ...
                            <app-function-section
                                *ngSwitchCase="'fn_calculate_fare'"
                            ...
                            <app-function-section
                                *ngSwitchCase="'fn_flight_duration'"
                            ...
                            <app-function-section
                                *ngSwitchCase="'fn_available_seats'"
                            ...
                            <app-function-section
                                *ngSwitchCase="'fn_flight_occupancy'"
                            ...
                            <app-function-section
                                *ngSwitchCase="'fn_format_currency'"
                            ...
                            <app-function-section
                                *ngSwitchCase="'fn_flight_number_format'"
                            ...
                            <app-function-section
                                *ngSwitchCase="'fn_total_baggage_weight'"
                            ...
                            <app-function-section
                                *ngSwitchCase="'fn_seats_by_class'"
                            ...
                            <app-procedure-section
                                *ngSwitchCase="'sp_create_booking'"
                            ...
                            <app-procedure-section
                                *ngSwitchCase="'sp_confirm_booking'"
                            ...
                            <app-procedure-section
                                *ngSwitchCase="'sp_check_in_passenger'"
                            ...
                            <app-procedure-section
                                *ngSwitchCase="'sp_cancel_booking'"
                            ...
                            <app-procedure-section
                                *ngSwitchCase="'sp_complete_maintenance'"
                            ...
                            <app-procedure-section
                                *ngSwitchCase="'sp_generate_daily_report'"
                            ...
                            <!-- Triggers -->
                            <app-trigger-section
                                *ngSwitchCase="'trg_after_booking_confirm'"
                            ...
                            <app-trigger-section
                                *ngSwitchCase="'trg_after_payment_insert'"
                            ...
                            <app-trigger-section
                                *ngSwitchCase="'trg_checkin_auto_bp'"
                            ...
                            <app-trigger-section
                                *ngSwitchCase="'trg_after_ticket_insert'"
                            ...
                            <app-trigger-section
                                *ngSwitchCase="'trg_after_ticket_delete'"
                            ...
                            <app-trigger-section
                                *ngSwitchCase="'trg_after_maintenance_insert'"
                            ...
                            <app-trigger-section
                                *ngSwitchCase="'trg_after_maintenance_complete'"
                            ...
                            <app-trigger-section
                                *ngSwitchCase="'trg_after_loyalty_transaction'"
                            ...
                            <app-trigger-section
                                *ngSwitchCase="'trg_flight_status_update'"
                            ...
                            <app-trigger-section
                                *ngSwitchCase="'trg_audit_delete_booking'"
                            ...
                            <!-- Vistas -->
                            <app-view-section
                                *ngSwitchCase="'vw_upcoming_flights'"
                            ...
                            <app-view-section
                                *ngSwitchCase="'vw_flight_manifest'"
                            ...
                            <app-view-section
                                *ngSwitchCase="'vw_flight_revenue'"
                            ...
                            <app-view-section
                                *ngSwitchCase="'vw_loyalty_member_points'"
                            ...
                            <app-view-section
                                *ngSwitchCase="'vw_airport_traffic'"
                            ...
                            <app-view-section
                                *ngSwitchCase="'vw_flight_status_latest'"
                            ...
                            <app-view-section
                                *ngSwitchCase="'vw_seat_availability'"
                            ...
                            <app-view-section
                                *ngSwitchCase="'vw_booking_summary'"
                            ...
                            ><!-- Eventos -->
                            <app-event-section
                                *ngSwitchCase="'ev_archive_old_flights'"
                            ...
                            <app-event-section
                                *ngSwitchCase="'ev_update_flight_status'"
                            ...
                            <app-event-section
                                *ngSwitchCase="'ev_cleanup_expired_bookings'"
                            ...
                            <app-event-section
                                *ngSwitchCase="'ev_send_departure_reminders'"
                            ...
                            <app-event-section
                                *ngSwitchCase="'ev_award_loyalty_monthly'"
    ...
    styles: [
        `
            ...
            :host ::ng-deep .p-scrollpanel-content-container {
                background: var(--bg-surface-900);
                border: var(--border-b);
                border-color: var(--border-slate-700);
            }
            ...
            /* Sidebar dark theme refuerzo */
            :host ::ng-deep .dark-sidebar {
                background: var(--bg-surface-900) !important;
                color: var(--text-white) !important;
                min-width: 18rem;
                max-width: 18rem;
                border-right: 1px solid var(--border-slate-700) !important;
                box-shadow:
                    0 0 0.3rem #000a,
                    0 0px 0px #000c;
            }
            ...
            :host ::ng-deep .dark-menu .p-panelmenu .p-panelmenu-header > a,
            :host ::ng-deep .dark-menu .p-panelmenu .p-panelmenu-content {
                background: #181c23 !important;
                color: #f3f4f6 !important;
            }
            :host ::ng-deep .dark-menu .p-panelmenu .p-panelmenu-header > a:hover,
            :host ::ng-deep .dark-menu .p-panelmenu .p-panelmenu-header.p-highlight > a {
                background: #23272f !important;
                color: #60a5fa !important;
            }
            :host ::ng-deep .dark-menu .p-panelmenu .p-menuitem-link {
                color: #f3f4f6 !important;
            }
            :host ::ng-deep .dark-menu .p-panelmenu .p-menuitem-link:hover,
            :host ::ng-deep .dark-menu .p-panelmenu .p-menuitem-link.p-highlight {
                background: #23272f !important;
                color: #60a5fa !important;
            }
            /* Ítem destacado personalizado */
            :host ::ng-deep .dark-menu .p-panelmenu .menuitem-featured > .p-menuitem-link {
                background: #23272f !important;
                color: #60a5fa !important;
                font-weight: 600;
                border-left: 4px solid #60a5fa;
            }
            :host ::ng-deep .dark-menu .p-panelmenu .menuitem-featured > .p-menuitem-link:hover,
            :host ::ng-deep .dark-menu .p-panelmenu .menuitem-featured > .p-menuitem-link.p-highlight {
                background: #1e293b !important;
                color: #93c5fd !important;
                border-left: 4px solid #93c5fd;
            }
            /* PanelMenu estilo custom tipo ejemplo adjunto */
            :host ::ng-deep .dark-menu .p-panelmenu {
                background: transparent !important;
                border: none !important;
                box-shadow: none !important;
            }
            :host ::ng-deep .dark-menu .p-panelmenu-panel {
                background: #181c23 !important;
            ...
            :host ::ng-deep .dark-menu .p-panelmenu-header > a {
                background: #181c23 !important;
            ...
            :host ::ng-deep .dark-menu .p-panelmenu-header > a:hover,
            :host ::ng-deep .dark-menu .p-panelmenu-header.p-highlight > a {
                background: #23242b !important;
                color: #fff !important;
            }
            :host ::ng-deep .dark-menu .p-panelmenu-content {
                background: #181c23 !important;
                border: none !important;
            ...
            :host ::ng-deep .dark-menu .p-panelmenu .p-menuitem-link {
                ...
                margin: 0 0.5rem;
                padding: 0.65rem 1.8rem 0.65rem 2.5rem !important;
                font-size: 1rem;
                font-weight: 500;
                transition:
                    background 0.15s,
            ...
            /* Ítem activo/hover: fondo blanco, texto e icono oscuros, sin borde ni sombra */
            :host ::ng-deep .dark-menu .p-panelmenu .p-menuitem-link:hover,
            :host ::ng-deep .dark-menu .p-panelmenu .p-menuitem-link.p-highlight {
            ...
            :host ::ng-deep .dark-menu .p-panelmenu .p-menuitem-link:hover .p-menuitem-icon,
            :host ::ng-deep .dark-menu .p-panelmenu .p-menuitem-link.p-highlight .p-menuitem-icon {
                color: var(--text-white) !important;
            }
            /* Ítems hijos (submenú) */
            :host ::ng-deep .dark-menu .p-panelmenu .p-panelmenu-content .p-menuitem-link {
                padding-left: 2.8rem !important;
                font-size: 0.97rem;
                color: var(--text-white) !important;
            }
            :host ::ng-deep .dark-menu .p-panelmenu .p-panelmenu-content .p-menuitem-link:hover,
            :host ::ng-deep .dark-menu .p-panelmenu .p-panelmenu-content .p-menuitem-link.p-highlight {
                background: var(--bg-white) !important;
                color: var(--text-white) !important;
                border-radius: 8px !important;
                box-shadow: none !important;
            ...
            :host ::ng-deep .dark-menu .p-panelmenu .p-panelmenu-content .p-menuitem-link:hover .p-menuitem-icon,
            :host ::ng-deep .dark-menu .p-panelmenu .p-panelmenu-content .p-menuitem-link.p-highlight .p-menuitem-icon {
                color: var(--text-white) !important;
            }
            /* Iconos */
            :host ::ng-deep .dark-menu .p-panelmenu .p-menuitem-icon,
            :host ::ng-deep .dark-menu .p-panelmenu .p-panelmenu-header .p-menuitem-icon {
                color: var(--text-white) !important;
                font-size: 1.1em;
                margin-right: 0.7em;
                transition: color 0.15s;
            }
            /* Quitar borde inferior entre ítems */
            :host ::ng-deep .dark-menu .p-panelmenu .p-menuitem {
                border-bottom: none !important;
            }
            /* Quitar sombra y bordes extra */
            :host ::ng-deep .dark-menu .p-panelmenu .p-panelmenu-header,
            :host ::ng-deep .dark-menu .p-panelmenu .p-panelmenu-content {
                box-shadow: none !important;
                border: none !important;
            }
            /* Ajuste de main para desktop */
            @media (min-width: 1024px) {
                :host ::ng-deep main.ml-72 {
            ...
            ::-webkit-scrollbar-track {
                background: transparent; /* canal “vacío” */
            }
            ...
            ::-webkit-scrollbar-thumb {
                ...
                border-radius: 4px;
                border: 2px solid transparent; /* “acolchado” interno */
                background-clip: content-box; /* respeta el borde   */
            }
...
export class AirlineDocComponent implements OnInit, AfterViewInit {
    ...
    public generalInfoData = generalInfoData;
    ...
    private buildMenu() {
        this.menuItems = [
            { label: 'General', icon: 'pi pi-info-circle', items: [{ label: 'Información General', icon: 'pi pi-home', command: () => this.navigateTo('database'), styleClass: 'menuitem-featured' }] },
            {
                label: 'Tablas',
                icon: 'pi pi-table',
                items: [
            ...
            { label: 'Seguridad', icon: 'pi pi-shield', items: [{ label: 'Roles y Usuarios', icon: 'pi pi-users', command: () => this.navigateTo('security') }] }
        ];
    }

    onCopy(txt: string) {
        navigator.clipboard.writeText(txt).then(() => this.toast.add({ severity: 'success', summary: 'Copiado', detail: 'Código al portapapeles', life: 1500 }));
    }
    ...
    @HostBinding('class.is-desktop') get hostDesktop() {
