...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, CodeCardComponent, TabViewModule, DividerModule, CardModule, TooltipModule, ChipModule],  template: `
      ...
      <p-tabView styleClass="custom-tabview">
        ...
        <p-tabPanel header="Información General">
          ...
          <div *ngIf="getDbEngine" class="mb-6">
            <h3 class="text-lg font-medium text-secondary-400 mb-3">Motor de Base de Datos</h3>
            <div class="bg-surface-700 p-4 rounded-lg">
              <div class="flex items-center gap-2 mb-4">
                <h4 class="text-xl font-semibold">{{ getDbEngine.name }}</h4>
          ...
          <div *ngIf="getErDiagramUrl" class="mb-6">
            <h3 class="text-lg font-medium text-secondary-400 mb-3">Diagrama Entidad-Relación</h3>
          ...
          <div *ngIf="getDirectoryStructure && getDirectoryStructure.length > 0" class="mb-6">
            <h3 class="text-lg font-medium text-secondary-400 mb-3">Estructura de Directorios</h3>
            <div class="bg-surface-700 p-4 rounded-lg">
          ...
          <div *ngIf="getVersionHistory && getVersionHistory.length > 0" class="mb-6">
            <h3 class="text-lg font-medium text-secondary-400 mb-3">Historial de Versiones</h3>
            <div class="relative overflow-x-auto">
              <table class="w-full border-collapse table-auto">
                ...
                <tbody>
                  <tr *ngFor="let version of getVersionHistory" class="hover:bg-surface-700">
