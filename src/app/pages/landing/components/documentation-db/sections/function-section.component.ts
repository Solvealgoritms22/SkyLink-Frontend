                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div *ngFor="let table of functionRelatedTables" class="bg-surface-700 p-4 rounded-lg border-l-4 border-blue-500">
                                <div class="flex items-center gap-2 mb-2">
                                    <span class="font-semibold text-slate-200">{{ table.tableName }}</span>
                                    <span class="text-xs px-2 py-1 rounded bg-surface-600 text-slate-300">{{ table.relationship }}</span>
                                </div>
