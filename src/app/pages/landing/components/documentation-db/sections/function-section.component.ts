      ...
      <p-tabView styleClass="custom-tabview">
        ...
        <p-tabPanel header="Detalles">
          <div class="mb-6">
            ...
            <div *ngIf="functionParameters && functionParameters.length > 0; else noParameters" class="overflow-x-auto rounded-md shadow">
              <table class="w-full border-collapse table-auto">
                ...
                <tbody>
                  <tr *ngFor="let param of functionParameters" class="hover:bg-surface-700">
            ...
            <h4 class="text-xl font-medium text-secondary-400 mb-2">Tipo de Retorno:</h4>
            <div class="bg-surface-700 p-3 rounded">
              <p class="font-mono">{{ functionReturnType }}</p>
          ...
          <div *ngIf="functionRelatedTables && functionRelatedTables.length > 0" class="mb-6">
            <h4 class="text-xl font-medium text-secondary-400 mb-2">Tablas Relacionadas:</h4>
          ...
          <div *ngIf="implementationNotes" class="mb-6">
            <h4 class="text-xl font-medium text-secondary-400 mb-2">Notas de Implementación:</h4>
