    ...
    template: `
        <div id="solutions" class="container mt-64">
            ...
            <div class="max-w-[40rem] mx-auto">
                <h1 class="text-3xl lg:text-7xl font-semibold text-surface-950 dark:text-surface-0">Sustainable Logistics Solutions</h1>
                <p class="text-xl text-surface-500 dark:text-white/64 mt-6">Explore the latest trends and advancements in logistics with expert insights and practical tips.</p>
                <a class="cursor-pointer button-gradient mt-6"> All Blogs <i class="pi pi-arrow-right !text-sm"></i></a>
            </div>
            ...
            <div class="mt-24 grid grid-cols-1 lg:grid-cols-3 gap-px rounded-4xl overflow-hidden" style="border-radius: 2rem;">
                ...
                <div class="relative h-[34rem] group animate-duration-500 animate-slidefadein">
                    ...
                    <img alt="Logistic Solutions Image" class="select-none object-cover group-hover:grayscale transition-all absolute w-full h-full" src="assets/img/solution-1-image.jpg" />
                    <div class="absolute left-8 right-8 bottom-8 flex flex-col gap-3" style="z-index: 2;">
                        ...
                        <h5 class="text-2xl title">Supply Chain Optimization</h5>
                        <p class="text-[#ffffffb8] text-lg">Learn strategies to streamline your supply chain and improve efficiency.</p>
                    </div>
                </div>
                ...
                <div class="relative h-[34rem] group animate-duration-500 animate-slidefadein">
                    ...
                    <img alt="Logistic Solutions Image" class="select-none object-cover group-hover:grayscale transition-all absolute w-full h-full" src="assets/img/solution-2-image.jpg" />
                    <div class="absolute left-8 right-8 bottom-8 flex flex-col gap-3" style="z-index: 2;">
                        <div class="flex items-center justify-between">
                            <span class="text-4xl text-[#ffffffb8] font-semibold">02</span>
                            <p-button class="group-hover:opacity-100 opacity-0 button-regular h-8 min-w-0 px-4" [icon]="'pi pi-arrow-right'" iconPos="right" [text]="true"></p-button>
                        </div>
                        <h5 class="text-2xl title">Yellow Logistics</h5>
                        <p class="text-[#ffffffb8] text-lg">Discover eco-friendly practices to make your logistics operations sustainable.</p>
                    </div>
                </div>
                ...
                <div class="relative h-[34rem] group animate-duration-500 animate-slidefadein">
                    <div class="absolute inset-0 bg-gradient-to-b from-transparent to-[rgba(0,0,0,0.40)] group-hover:bg-[rgba(37,99,235,0.10)] transition-all" style="z-index: 1;"></div>
                    <img alt="Logistic Solutions Image" class="select-none object-cover group-hover:grayscale transition-all absolute w-full h-full" src="assets/img/solution-3-image.jpg" />
                    <div class="absolute left-8 right-8 bottom-8 flex flex-col gap-3" style="z-index: 1;">
                        ...
                        <h5 class="text-2xl title">Future of Logistics Tech</h5>
                        <p class="text-[#ffffffb8] text-lg">Explore the latest technological advancements transforming the logistics industry.</p>
                    </div>
                </div>
            </div>
        </div>
