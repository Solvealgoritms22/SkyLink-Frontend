  ...
  template: `
    <div id="testimonial" class="testimonial-container">
      ...
      <div class="title-section">
        ...
        <p class="subtitle">
          Our clients’ satisfaction is our top priority. Hear from those who have experienced
          our exceptional logistics services firsthand. Their feedback drives us to
            ...
            <div class="carousel-item-wrapper">
              <div class="testimonial-card">
                  ...
                  <div class="author-info">
                    <div class="avatar">
                      ...
                      <img
                        ...
                        [class.hidden]="!testimonial.avatarLoaded"
                        (load)="onAvatarLoad(testimonial)"
                      />
                    </div>
                    <div>
                ...
                <div class="testimonial-image-wrapper">
                  <p-skeleton
                    *ngIf="!testimonial.imageLoaded"
                    styleClass="w-full h-full"
                  ></p-skeleton>
                  <img
                    [src]="testimonial.image"
                    [alt]="testimonial.title"
                    [class.hidden]="!testimonial.imageLoaded"
                    (load)="onImageLoad(testimonial)"
                    (error)="onImageError(testimonial)"
                  />
                </div>
              </div>
            </div>
...
export class TestimonialWidget {
  testimonials = [
    ...
    },
    {
      ...
      role: 'Supply Chain Coordinator',
      avatar: 'assets/avatars/female-9.jpg',
      image: 'assets/img/services-background.jpg',
      imageLoaded: false,
      avatarLoaded: false,
      error: false
    }
